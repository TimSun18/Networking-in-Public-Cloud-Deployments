...
#### Step 2
Because ansible module ec2_vpc_net cannot be used to enalbe IPv6 CIDR block when creatin the VPC, need to manually enable the Amazon provided IPv6 CIDR block.
